...
int waitRefCli(WiFiClient* cli,char* ref,int lref,char* buf,int lbuf);
int waitRefCli(WiFiClient* cli,char* ref,int lref,char* buf,int lbuf,bool diags);            // attente d'un chaine spécifique dans le flot
