...
int messToServer(WiFiClient* cli,IPAddress* host,int port,char* data);    // connecte au serveur et transfère la data
int messToServer(WiFiClient* cli,IPAddress* host,int port,char* data,WiFiServer* server,WiFiClient* cliext);    // connecte au serveur et transfère la data
