...
#define ST7789_76x284_XSTART 0
#define ST7789_76x284_YSTART 0

#define ST_CMD_DELAY   0x80

// Initialization commands for ST7789 76x284 1.3" IPS
// taken from Adafruit
static const uint8_t PROGMEM init_76x284[] = {
    ...
    ST7789_CASET  , 4,  					// 5: Column addr set, 4 args, no delay:
      0x00, ST7789_76x284_XSTART,          // XSTART = 0
	    (ST7789_TFTWIDTH+ST7789_76x284_XSTART) >> 8,
	    (ST7789_TFTWIDTH+ST7789_76x284_XSTART) & 0xFF,   // XEND = 284
    ST7789_RASET  , 4,  					// 6: Row addr set, 4 args, no delay:
      0x00, ST7789_240x240_YSTART,          // YSTART = 0
      (ST7789_TFTHEIGHT+ST7789_76x284_YSTART) >> 8,
	    (ST7789_TFTHEIGHT+ST7789_76x284_YSTART) & 0xFF,	// YEND = 76
